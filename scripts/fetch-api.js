            ...
            <div class="card" id="${game.id}">
                <div class="modal_container">
                    ...
                    <div class="card_content">
                        ...
                        <div class="card_info">
                            <ul>
                                <li class='hide'>Platforms
                                    <span class="platforms">${
                                        game.parent_platforms[0] ||
                                        "Information not provided"
                                    }
                                    ${
                                        game.parent_platforms[1] ||
                                        "Information not provided"
                                    }
                                    </span>
                                </li>
                                ...
                                <li class="hide">Publisher
                                    <span class="publisher">${
                                        game.publishers ||
                                        "Information not provided"
                                    }</span>
                                </li>
                                <li class="hide">Website
                                    <span class="website">${
                                        game.website ||
                                        "Information not provided"
                                    }</span>
                                ...
                                <li class="hide">Developer
                                    <span class="developer">${
                                        game.developers ||
                                        "Information not provided"
                                    }</span>
                                </li>
                                <li class="hide">Age rating
                                    <span class="age">${
                                        game.esrb_rating ||
                                        "Information not provided"
                                    }</span>
                        ...
                        <div class="card_video">
                            <video class="game_video" src=""></video>
                        </div>
                        <div class="hide card_imgs">
                            <img src="" alt="">
                        </div>
